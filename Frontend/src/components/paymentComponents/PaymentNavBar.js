...
import { fetchPaymentByBooking, fetchPaymentByVehicle, fetchPayments } from "../../actions/paymentAction"
...
export const PaymentNavBar = ({isAdmin}) => {
        ...
        <div className={classes.root}>
            <AppBar position="static" style={{ backgroundColor: 'ghostwhite ', color: 'black' }}>
                <Toolbar>
                    ...
                    {isAdmin ? <><Typography style={{ margin: "10px" }}><Link to="/viewTotalRevenue" style={{ textDecoration: 'none', color: 'black' }}>Total Revenue</Link></Typography>
